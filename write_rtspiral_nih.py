...
if 'vds_factor' in params['spiral']:
    vds = params['spiral']['vds_factor']
else:
    vds = None
k, g, t, n_int = vds_fixed_ro(spiral_sys, fov, res, Tread, vds=vds)
...
if grad_rew_method == 1:
    ...
    gropt_params['smax'] = params['system']['max_slew']*params['spiral']['slew_ratio']*0.77
    gropt_params['dt']   = GRT
